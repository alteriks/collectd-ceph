    ...
    def get_stats(self):
        ...
        try:
            output = subprocess.check_output(
              "timeout 30s docker exec ceph_mon rados --cluster "+ self.cluster +" -p backups bench 10 write -t 1 -b 65536 2>/dev/null | grep -i latency | awk '{print 1000*$3}'", shell=True)
